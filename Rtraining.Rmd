...
hist(log10(Bonferroni.ttest), 
     breaks = 100, 
     xlim = c(-0.6,0),
     main = "Histogram of log10(ttest.pvalue)");

Bonferroni.wilcoxon =p.adjust(tumor.wilcoxon$pvalue, method = "bonferroni");
hist(log10(Bonferroni.wilcoxon),
     xlim = c(-0.05,0.05),
     breaks = c(-0.025,0,0.025),
     main = "Histogram of log10(wilcoxon.pvalue)");
```
...
hist(log10(FDR.ttest), 
     breaks = 50, 
     xlim = c(-1,0),
     main = "Histogram of log10(FDR.ttest.pvalue)");

FDR.wilcoxon =p.adjust(tumor.wilcoxon$pvalue, method = "BH");
hist(log10(FDR.wilcoxon), 
     breaks = 50, 
     xlim = c(-0.2,0),
     main = "Histogram of log10(FDR.wilcoxon.pvalue)");
...
Bonferroni.ttest =p.adjust(tumor.ttest$pvalue, method = "bonferroni");
create.histogram(log10(Bonferroni.ttest), 
                 type = 'count',
                 breaks=50, 
                 ylab.label = 'Counts', 
                 xlab.label = 'log10(Pvalues)', 
                 xlab.cex = 1.5,
                 ylab.cex = 1.5,
                 main = "Histogram of Bonferroni adjusted log10 ttest p values",
                 main.cex = 1.2
                 );

Bonferroni.wilcoxon =p.adjust(tumor.wilcoxon$pvalue, method = "bonferroni");
create.histogram(log10(Bonferroni.wilcoxon), 
                 type = 'count',
                 ylab.label = 'Counts', 
                 xlab.label = 'log10(Pvalues)', 
                 xlab.cex = 1.5,
                 ylab.cex = 1.5,
                 main = "Histogram of Bonferroni adjusted log10 Wilconxon test p values",
                 main.cex = 1.2
                 );
# False Discover Rate controls the number of false positives copared to the total number of positives
# The methods BH (Benjamini–Hochberg, which is the same as FDR in R) and BY control the false discovery rate. 
FDR.ttest =p.adjust(tumor.ttest$pvalue, method = "BH");
create.histogram(log10(FDR.ttest), 
                 ...
                 xlab.cex = 1.5,
                 ylab.cex = 1.5,
                 main = "Histogram of BH adjusted log10 ttest p values",
                 main.cex = 1.2
                 );

FDR.wilcoxon =p.adjust(tumor.wilcoxon$pvalue, method = "BH");
create.histogram(log10(FDR.wilcoxon), 
                 type = 'count', 
                 breaks=50,
                 ylab.label = 'Counts', 
                 xlab.label = 'log10(Pvalues)', 
                 xlab.cex = 1.5,
                 ylab.cex = 1.5,
                main = "Histogram of BH adjusted log10 Wilconxon p values",
                 main.cex = 1.2
                );
